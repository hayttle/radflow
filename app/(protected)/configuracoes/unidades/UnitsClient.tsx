...
export function UnitsClient({
  ...
  units: Unit[];
  printPreviewProfile: PrintPreviewProfile | null;
}) {
  ...
  const COLUMNS: DataTableColumn<Unit>[] = [
    ...
    },
    {
      key: "address",
      label: "Endereço",
      render: (row) => <span className="text-muted-foreground">{row.address || "Sem endereço"}</span>
    },
    {
      key: "phone",
      label: "Telefone",
      render: (row) => <span className="text-muted-foreground">{row.phone || "Sem telefone"}</span>
    },
    {
      key: "actions",
      label: "Ações",
  ...
  return (
    <>
      ...
      <UnitSheet
        ...
        unit={editingUnit}
        printPreviewProfile={printPreviewProfile}
      />
