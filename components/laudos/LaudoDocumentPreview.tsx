    ...
    <div className="space-y-6 report-body max-w-none text-black">
      <section>
        ...
        <p className="text-[14px]">
          Realizado exame ultrassonográfico do abdome total com equipamento de alta resolução,
          utilizando transdutor convexo multifrequencial.
        </p>
      </section>
      <section>
        <h2 className="text-sm font-bold uppercase mb-2 pb-1 border-b border-black/10">Resultado</h2>
        <p className="text-[14px]">
          Fígado com dimensões preservadas, contornos regulares, ecotextura homogênea. Sem imagens
          nodulares focais. Vesícula biliar com paredes finas, sem cálculos. Vias biliares intra e
          extra-hepáticas sem dilatação. Pâncreas de aspecto usual. Baço com volume normal,
          estrutura homogênea. Rins com dimensões normais, boa diferenciação córtico-medular.
        </p>
      </section>
 ...
 */
export function LaudoDocumentPreview({
  unitName,
  reportHeader,
  reportFooter,
  profile,
}: LaudoDocumentPreviewProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full h-full bg-gray-300 rounded-lg flex flex-col items-center gap-2 p-2"
    >
      {scale > 0 && (
        <div
